...
export default class Renderer {
    ...
    setInstance() {
        ...
        this.instance.shadowMap.type = THREE.PCFSoftShadowMap // default THREE.PCFShadowMap
        ...
        document.querySelector('#overlay')?.appendChild(this.overlayInstance.domElement)
